    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Phone className="h-4 w-4" style={{ color: "var(--accent-text)" }} />
            {business.phone}
          </a>
          <a
            href="#quote"
            className="hidden rounded-full px-5 py-2.5 font-body text-sm font-semibold shadow-sm transition-transform hover:scale-[1.03] md:inline-block"
            style={{ background: "var(--accent)", color: "var(--on-accent)" }}
          >
            Get a Quote
          </a>
      ...
      {open && (
        <div className="border-t border-white/10 bg-[var(--brand)]/98 backdrop-blur-md lg:hidden">
          <nav className="mx-auto flex max-w-7xl flex-col gap-1 px-5 py-4">
            ...
            >
              <Phone className="h-5 w-5" style={{ color: "var(--accent-text)" }} />
              {business.phone}
            </a>
          </nav>
        </div>
