      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid gap-12 md:grid-cols-[1.3fr_1fr_1fr]">
          ...
          <div>
            ...
            <p className="spec mt-2 text-xs uppercase tracking-wider text-white/35">
              Serving {business.serviceAreas.slice(0, 4).join(" · ")}
            </p>
          </div>
              ...
              {business.email && (
                <li>
                  <a
                    ...
                    className="flex items-center gap-3 text-white/80 transition-colors hover:text-white"
                  >
                    <Mail className="h-4 w-4" style={{ color: "var(--accent-text)" }} />
                    {business.email}
                  </a>
                </li>
              )}
